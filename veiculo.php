...
if ($camposOk) {
    ...
    $sql = "INSERT INTO veiculo (placa, ano, marca, modelo, diaria, preco) VALUES
                   ( '$placa', '$ano', '$marca', '$modelo','$diaria', '$preco' ) ";

    mysql_query($sql) or die("ERRO ao INSERIR na tabela VEICULO. " . mysql_error());
    $cod = mysql_insert_id();

    $msg = "Veículo CADASTRADO com SUCESSO!";
    header("Location:cadastrarVeiculo.php?msg=$msg&id=$id");
} else {
